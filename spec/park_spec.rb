...
RSpec.describe Park do
  ...
  it "can list all passengers who entered the park" do
    park = Park.new("Grand Canyon", 25)
    vehicle1 = Vehicle.new("2001", "Honda", "Civic")
    vehicle2 = Vehicle.new("2019", "Ferrari", "F50")
    vehicle3 = Vehicle.new("2010", "Ford", "Focus")
    ...
    park.add_vehicle(vehicle2)
    park.add_vehicle(vehicle3)
    expect(park.all_attendees).to eq(["Charlie", "John", "Jude", "Mary", "Taylor", "Tom"])
  end

  it "can list all minors who entered the park" do
    park = Park.new("Grand Canyon", 25)
    vehicle1 = Vehicle.new("2001", "Honda", "Civic")
    vehicle2 = Vehicle.new("2019", "Ferrari", "F50")
    vehicle3 = Vehicle.new("2010", "Ford", "Focus")
    ...
    park.add_vehicle(vehicle2)
    park.add_vehicle(vehicle3)
    expect(park.minors).to eq(["Taylor", "Tom"])
  end

  it "can list all adults who entered the park" do
    park = Park.new("Grand Canyon", 25)
    vehicle1 = Vehicle.new("2001", "Honda", "Civic")
    vehicle2 = Vehicle.new("2019", "Ferrari", "F50")
    vehicle3 = Vehicle.new("2010", "Ford", "Focus")
    ...
    park.add_vehicle(vehicle2)
    park.add_vehicle(vehicle3)
    expect(park.adults).to eq(["Charlie", "John", "Jude", "Mary"])
  end
end